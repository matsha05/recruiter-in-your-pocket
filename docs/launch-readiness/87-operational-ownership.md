...
Support forwarding uses Resend's free plan and works only within the provider's current quota. It is not unlimited. Monitor quota in Resend, and keep API keys and webhook secrets in environment configuration.
