...
|:--------|:--------------|
| Hero | "See what recruiters see in 6 seconds" |
...
│    Impact: Numbers stand out in 6-second scan      │
│                                           [Copy]   │
├─────────────────────────────────────────────────────┤
...
**Hero:**
> See what recruiters see in 6 seconds
...
| 3 | "Identifying what stands out in 6 seconds..." |
...
|:--------|:-------|:-------|
| Score | "Your Resume Score" | "Based on how a recruiter would read this in 6 seconds" |
...
| 6-second frame | Tied to "6-second recruiter scan" narrative |
