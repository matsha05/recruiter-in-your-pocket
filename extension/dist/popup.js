...
function AuthPrompt({ onLogin }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "empty-state", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-state-title", children: "Sign in to sync" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-state-description", children: "Connect your RIYP account to save jobs across devices and get personalized match scores." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn btn-primary", onClick: onLogin, style: { marginTop: 8 }, children: [
      "Sign In",
