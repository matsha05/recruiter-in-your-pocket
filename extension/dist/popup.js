...
function PopupHeader({ user }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "popup-header", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-logo", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-logo-mark", children: "R" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "popup-logo-text", children: "Recruiter in Your Pocket" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-status", children: user ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "popup-status-dot" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: user.firstName || user.email.split("@")[0] })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "popup-status-text", children: "Not signed in" }) })
  ] });
}
...
function QuickMatchCard({ job, onClick, onDelete }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "job-card", onClick, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "job-actions", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "job-arrow", children: "→" })
    ] })
  ] });
}
function ScoreDial({ score }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "score-dial", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 48 48", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "circle",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `score-dial-text score-${scoreClass}`, children: score || "—" })
  ] });
}
...
function RecentJobsList({ jobs, onJobClick, onDeleteJob }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "section-title", children: [
        "RECENT JOBS (",
        jobs.length,
        ")"
      ] }),
      jobs.length > 5 && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-ghost", onClick: handleViewAll, children: "View All" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "jobs-list", children: jobs.slice(0, 5).map((job) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      QuickMatchCard,
      {
        job,
...
function AuthPrompt({ onLogin }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-prompt", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "auth-title", children: "Sign in to unlock" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "auth-description", children: "Connect your RIYP account to save jobs across devices and get personalized match scores." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-buttons", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn btn-google", onClick: handleGoogleLogin, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 24 24", className: "google-icon", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-divider", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "or" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-secondary", onClick: onLogin, children: "Sign in with Email" })
    ] }),
...
function Onboarding({ onComplete }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-hero", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "onboarding-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          viewBox: "0 0 24 24",
          fill: "none",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "onboarding-title", children: "Recruiter in Your Pocket" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "onboarding-subtitle", children: "See what recruiters see. Get matched instantly." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-features", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-feature", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "feature-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "One-Click Capture" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Save job descriptions from LinkedIn and Indeed" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-feature", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "feature-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M22 12h-4l-3 9L9 3l-3 9H2" }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Instant Match Score" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Know how well you fit before you apply" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "onboarding-feature", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "feature-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Full Analysis" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Deep insights in RIYP Studio" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn btn-primary onboarding-cta", onClick: onComplete, children: [
      "Get Started",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "btn-arrow", children: "→" })
    ] })
  ] });
}
...
function UndoToast({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `undo-toast ${isVisible ? "visible" : ""}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "undo-message", children: message }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "undo-button", onClick: handleUndo, children: "Undo" })
  ] });
}
...
function App() {
  ...
  const [deletedJob, setDeletedJob] = reactExports.useState(null);
  reactExports.useEffect(() => {
    initialize();
  }, []);
  ...
  const handleUndoDismiss = reactExports.useCallback(() => {
    setDeletedJob(null);
  }, []);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PopupHeader, { user }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-content", children: [
      ...
      state === "error" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "empty-state", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-state-title", children: "Something went wrong" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-state-description", children: error }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-secondary", onClick: loadJobs, children: "Try Again" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-footer", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn btn-primary", onClick: handleOpenStudio, children: [
      "Open RIYP Studio",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "btn-arrow", children: "→" })
    ] }) }),
    deletedJob && /* @__PURE__ */ jsxRuntimeExports.jsx(
      UndoToast,
      {
...
function LoadingSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-header", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "skeleton", style: { width: 100, height: 12 } }) }),
    [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "job-card", style: { opacity: 0.6 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "skeleton", style: { width: 44, height: 44, borderRadius: "50%" } }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "job-info", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "skeleton", style: { width: "70%", height: 13, marginBottom: 6 } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "skeleton", style: { width: "50%", height: 12 } })
      ] })
    ] }, i))
  ] });
}
