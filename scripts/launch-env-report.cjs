...
const flags = [
  ...
  ["RIYP_DISABLE_NEW_PURCHASES", enabled(process.env.RIYP_DISABLE_NEW_PURCHASES, false)],
  ...
  ["RIYP_SECONDARY_ALERT_VERIFIED", enabled(process.env.RIYP_SECONDARY_ALERT_VERIFIED, false)],
];
