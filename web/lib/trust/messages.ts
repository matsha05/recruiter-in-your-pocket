export const workspaceTrustMessage = {
  ...
  body:
    "Your upload is encrypted in transit. Anonymous reports are not attached to an account unless you choose to sign in and save them.",
  detail:
    "Signed-in reports add history and a short resume preview you can delete from Reports or Settings.",
};

export const saveReportTrustMessage =
  "We only save reports to verified signed-in accounts. Nothing is created in the background, and nothing gets handed off to an unverified email.";
...
export const billingTrustMessage = {
