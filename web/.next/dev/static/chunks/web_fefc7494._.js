...
_s(WorkspaceHeader, "V8e9uWL0aZcxWbWsGpr6VZQUTDg=");
_c = WorkspaceHeader;
var _c;
...
function PaywallModal({ isOpen, onClose, freeUsesRemaining = 0, hasCurrentReport = false, onSuccess }) {
    ...
    const [step, setStep] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("select");
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    // Dynamic header based on free uses remaining
    const getHeaderText = ()=>{
        if (freeUsesRemaining === 2) {
    ...
    const handleVerifyCode = async ()=>{
        ...
        try {
            ...
            await refreshUser();
            // Check if this is a new user (no first name yet)
            // We'll prompt for name before checkout
            setStep("name");
        } catch (err) {
    ...
    const handleSaveName = async ()=>{
        ...
        try {
            // Save name via API
            const { createSupabaseBrowserClient } = await __turbopack_context__.A("[project]/web/lib/supabase/browserClient.ts [app-client] (ecmascript, async loader)");
            ...
            // Even if name save fails, proceed to checkout
            await proceedToCheckout();
        }
    };
    const proceedToCheckout = async ()=>{
        ...
        setError(null);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createCheckoutSession"])(selectedTier);
    ...
    const greenBg = "bg-emerald-600";
    const greenBorder = "border-emerald-600";
    const greenBorderHover = "hover:border-emerald-400";
    const greenBgLight = "bg-emerald-50";
    const greenText = "text-emerald-600";
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            className: `flex-1 p-5 rounded-xl text-center transition-all
                            ${selectedTier === "30d" ? `border-2 ${greenBorder} ${greenBgLight} dark:bg-emerald-500/10` : `border-2 border-gray-200 dark:border-gray-700 ${greenBorderHover}`}`,
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: `inline-block px-3 py-1 text-[11px] font-semibold uppercase tracking-wide
                            rounded ${greenBg} text-white mb-3`,
                                    children: "Best value"
                                }, void 0, false, {
                                    fileName: "[project]/web/components/workspace/PaywallModal.tsx",
                                    lineNumber: 234,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: `text-3xl font-extrabold ${greenText} mb-1`,
                                    children: "$39"
                                }, void 0, false, {
                                    fileName: "[project]/web/components/workspace/PaywallModal.tsx",
                                    lineNumber: 238,
                ...
                isLoggedIn ? // LOGGED IN: Skip email verification, go straight to checkout
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    lineNumber: 249,
                    columnNumber: 21
                }, this) : step === "select" ? // NOT LOGGED IN: Email entry
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-gray-50 dark:bg-gray-800/50 rounded-xl p-5 mb-4",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                            ...
                            children: "Your email for checkout"
                        }, void 0, false, {
                            fileName: "[project]/web/components/workspace/PaywallModal.tsx",
                            lineNumber: 265,
                            columnNumber: 25
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "We'll send a quick verification code, then take you to checkout."
                        }, void 0, false, {
                            fileName: "[project]/web/components/workspace/PaywallModal.tsx",
                            lineNumber: 275,
                            columnNumber: 25
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            className: "btn-primary w-full",
                            children: loading ? "Sending..." : `Continue to buy ${selectedTier === "24h" ? "24-Hour" : "30-Day"} Pass →`
                        }, void 0, false, {
                            fileName: "[project]/web/components/workspace/PaywallModal.tsx",
                            lineNumber: 278,
                            columnNumber: 25
                    ...
                    lineNumber: 264,
                    columnNumber: 21
                }, this) : step === "code" ? // NOT LOGGED IN: Code verification
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-gray-50 dark:bg-gray-800/50 rounded-xl p-5 mb-4",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                    ...
                    lineNumber: 289,
                    columnNumber: 21
                }, this) : // NOT LOGGED IN: Name collection (optional)
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-gray-50 dark:bg-gray-800/50 rounded-xl p-5 mb-4",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                            className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2",
                            children: "What should we call you? (optional)"
                        }, void 0, false, {
                            fileName: "[project]/web/components/workspace/PaywallModal.tsx",
                            lineNumber: 313,
                            columnNumber: 25
...
_s(PaywallModal, "LOod2UNb3Spp8+zBl5yhQWnckg8=", false, function() {
    return [
...
//# sourceMappingURL=web_fefc7494._.js.map