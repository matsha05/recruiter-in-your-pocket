    ...
    return (
        <div className="min-h-screen bg-surface">
            ...
            <main className="max-w-3xl mx-auto px-6 py-12">
                <div className="mb-8">
                    <h1 className="font-display text-3xl md:text-4xl font-bold text-primary mb-2">Privacy Policy</h1>
                    <p className="text-muted">Last updated: December 2024</p>
                </div>

                <div className="bg-brand-soft rounded-xl p-4 mb-8 border border-brand/20">
                ...
                <div className="prose prose-gray dark:prose-invert max-w-none space-y-6">
                    <section>
                        <h2 className="font-display text-xl font-bold text-primary mb-3">1. What We Collect</h2>
                        <p className="text-secondary mb-3">When you use Recruiter in Your Pocket, we may collect:</p>
                    ...
                    <section>
                        <h2 className="font-display text-xl font-bold text-primary mb-3">2. Data Retention</h2>
                        <ul className="list-disc pl-5 space-y-2 text-secondary">
                    ...
                    <section>
                        <h2 className="font-display text-xl font-bold text-primary mb-3">3. How We Use Your Data</h2>
                        <ul className="list-disc pl-5 space-y-2 text-secondary">
                    ...
                    <section>
                        <h2 className="font-display text-xl font-bold text-primary mb-3">4. What We Don&apos;t Do</h2>
                        <ul className="list-disc pl-5 space-y-2 text-secondary">
                        ...
                        <p className="text-secondary mt-3">
                            ...
                            <a href="https://openai.com/policies/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-brand hover:underline">privacy policy</a>.
                        </p>
                    </section>

                    <section>
                        <h2 className="font-display text-xl font-bold text-primary mb-3">5. Cookies and Tracking</h2>
                        <p className="text-secondary mb-3">We use cookies to:</p>
                        <ul className="list-disc pl-5 space-y-2 text-secondary">
                    ...
                    <section>
                        <h2 className="font-display text-xl font-bold text-primary mb-3">6. Third-Party Services</h2>
                        <ul className="list-disc pl-5 space-y-2 text-secondary">
                    ...
                    <section>
                        ...
                        <p className="text-secondary mb-3">You have the right to:</p>
                        <ul className="list-disc pl-5 space-y-2 text-secondary">
                    ...
                    <section>
                        <h2 className="font-display text-xl font-bold text-primary mb-3">8. Contact</h2>
                        <p className="text-secondary">If you have questions about this Privacy Policy or want to exercise your data rights, please reach out via our website.</p>
                    </section>
                </div>
