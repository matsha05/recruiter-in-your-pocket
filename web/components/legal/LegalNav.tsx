                ...
                {tabs.map((tab) => {
                    ...
                    return (
                        <Link
                            ...
                            className={cn(
                                "focus-ring inline-flex min-h-11 snap-start items-center whitespace-nowrap rounded-full border px-4 py-2 text-sm font-medium transition-colors duration-fast ease-snap motion-reduce:transition-none",
                                isActive
