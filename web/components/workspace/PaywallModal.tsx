...
export default function PaywallModal({
    ...
    if (!billingEnabled) {
        return (
            <Dialog open={isOpen} onOpenChange={handleOpenChange}>
                <DialogContent disableMotion className="max-w-md p-7">
    ...
    return (
        <Dialog open={isOpen} onOpenChange={handleOpenChange}>
            <DialogContent disableMotion className="max-w-[440px] p-6 sm:p-7">
                ...
                <div className="mb-5 grid grid-cols-[0.8fr_1.2fr] border-y border-line py-4">
                    ...
                    <div className="border-l border-line pl-4 text-sm leading-6 text-muted-foreground">
                        Five careful reports. {JOB_SEARCH_PASS_DECISION.terms}
                    </div>
                </div>
