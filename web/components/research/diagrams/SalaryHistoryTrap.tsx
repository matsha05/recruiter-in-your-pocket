        ...
        <figure className="riyp-figure w-full max-w-2xl mx-auto my-10">
            <div className="riyp-figure-frame p-6 grid md:grid-cols-2 gap-8">
                <div className="border border-border/30 bg-background p-6">
                    <div className="riyp-figure-kicker mb-3">Social pressure</div>
                ...
                <div className="border border-brand/30 bg-brand/5 p-6">
                    <div className="riyp-figure-kicker mb-3">Strategy</div>
