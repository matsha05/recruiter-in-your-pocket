            ...
            <div className="space-y-6">
                ...
                <div className="relative">
                    ...
                    <div className="relative h-12 w-full bg-transparent rounded-md flex">
                        ...
                        <motion.div
                            ...
                            className="h-full bg-gold/10 border border-gold/20 rounded-l-md flex items-center px-4"
                        >
                            <span className="text-sm font-medium text-gold">Qualified</span>
                        </motion.div>
                        {/* The Knockouts */}
                ...
                <div className="relative">
                    <div className="flex justify-between text-xs uppercase tracking-wider text-muted-foreground mb-2">
                        ...
                        <span className="text-gold font-bold">50 Seen (5%)</span>
                    </div>
                    <div className="h-12 w-full bg-secondary/30 rounded-md border border-border border-dashed flex relative overflow-hidden">
                        ...
                        <motion.div
                            ...
                            className="h-full bg-gold absolute left-0 top-0 shadow-[0_0_15px_rgba(251,191,36,0.5)]"
                        />
