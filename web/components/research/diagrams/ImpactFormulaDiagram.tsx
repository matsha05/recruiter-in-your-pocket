        ...
        <DiagramFigure className="max-w-[43rem]" label="Framework for writing a resume bullet using result, scale, and method">
            <DiagramFrame>
                ...
                <FrameworkStrip
                    ...
                    example={<><span className="riyp-evidence-label text-brand">Illustrative example</span><p className="mt-2 text-base text-foreground">Cut onboarding time 32% by coordinating training across product, sales, and support.</p><p className="mt-2 text-data text-muted-foreground">The number and details belong to this example. Use your own verified facts.</p></>}
                />
            </DiagramFrame>
