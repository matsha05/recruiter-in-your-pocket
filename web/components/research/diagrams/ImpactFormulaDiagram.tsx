                        ...
                        {formula.map((item, i) => (
                            ...
                            >
                                <div className="text-center">
                                    <div className={`size-14 rounded-xl border-2 flex items-center justify-center shadow-sm ${item.color === "brand"
                                    ...
                                    <p className="text-xs font-mono uppercase tracking-wider text-muted-foreground/70 mt-2">
                                        {item.label}
                                    </p>
                                </div>
