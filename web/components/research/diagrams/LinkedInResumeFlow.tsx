...
export function LinkedInResumeFlow() {
    return (
        <DiagramFigure className="w-full max-w-[540px] mx-auto my-12 group select-none">
            <DiagramFrame
            ...
            >
                ...
                <div className="p-6">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        ...
                        >
                            <div className="flex items-center gap-3">
                                <div className="size-10 rounded-lg bg-[#0A66C2]/10 dark:bg-[#0A66C2]/20 border border-[#0A66C2]/20 flex items-center justify-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs font-mono uppercase tracking-wide text-muted-foreground/70">Discovery</p>
                                </div>
                            </div>
                            ...
                            <div className="gap-y-2">
                                {[
                                    ...
                                    <motion.div
                                        ...
                                        whileInView={{ opacity: 1, x: 0 }}
                                        transition={{ duration: 0.3, ease: [0.16, 1, 0.3, 1], delay: 0.3 + i * 0.1 }}
                                        viewport={{ once: true }}
                        ...
                        >
                            <div className="flex items-center gap-3">
                                <div className="size-10 rounded-lg bg-brand/10 dark:bg-brand/20 border border-brand/20 flex items-center justify-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs font-mono uppercase tracking-wide text-muted-foreground/70">Evaluation</p>
                                </div>
                            </div>
                            ...
                            <div className="gap-y-2">
                                {[
                                    ...
                                    <motion.div
                                        ...
                                        initial={{ opacity: 0, x: 10 }}
                                        whileInView={{ opacity: 1, x: 0 }}
                                        transition={{ duration: 0.3, ease: [0.16, 1, 0.3, 1], delay: 0.4 + i * 0.1 }}
                                        viewport={{ once: true }}
                                        className="flex items-center gap-2.5 p-2.5 rounded-lg bg-muted/20 dark:bg-muted/10 border border-border/20"
                                    >
                                        {item.icon}
                    ...
                    >
                        <div className="flex items-center gap-3">
                            <div className="size-10 rounded-full bg-white dark:bg-card border border-border/40 shadow-sm flex items-center justify-center shrink-0">
                                <svg className="size-5 text-brand" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
