    ...
    return (
        <DiagramFigure className="max-w-[47rem]" label="Comparison between skills-first hiring promises and observed hiring practices">
            <DiagramFrame>
                ...
                <ComparisonField
                    left={{ eyebrow: "What hiring promises", title: "Ability over pedigree", tone: "insight", items: ["Skills matter more than degrees", "Potential widens the talent pool", "Demonstrated ability should lead"] }}
