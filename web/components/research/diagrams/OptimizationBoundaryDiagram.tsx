    ...
    return (
        <DiagramFigure className="max-w-[46rem]" label="Boundary between resume factors a candidate can improve and hiring factors outside the candidate's control">
            <DiagramFrame>
                ...
                <ComparisonField
                    left={{ eyebrow: "Inside your control", title: "What you can make clearer", tone: "insight", items: ["Writing clarity", "Specific evidence", "Structure and formatting", "Language relevant to the role"] }}
                    ...
                    verdict={<><strong className="text-foreground">Keep the promise honest:</strong> make your experience easy to understand without pretending the resume controls the whole outcome.</>}
                />
            </DiagramFrame>
