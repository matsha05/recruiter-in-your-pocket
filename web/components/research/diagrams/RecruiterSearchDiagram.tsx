    ...
    return (
        <DiagramFigure className="max-w-[46rem]" label="What is publicly known and unknown about recruiter search">
            <DiagramFrame>
                ...
                <ComparisonField
                    left={{ eyebrow: "Published or observable", title: "What we can support", tone: "teal", items: ["Platform scale and activity", "Recruiter usage surveys", "Skills-first sourcing findings"] }}
                    ...
                    verdict={<><strong className="text-slate-950">The useful advice:</strong> use accurate role language and complete your profile. Ignore anyone promising a secret ranking formula.</>}
                />
            </DiagramFrame>
