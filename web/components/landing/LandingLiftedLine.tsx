                ...
                <div className="lift-credibility-copy">
                    ...
                    <div className="lift-founder-profile">
                        ...
                        <div>
                            ...
                            <p>Fourteen years in recruiting and hiring taught me how quickly good experience gets missed. I built RIYP to give candidates the honest résumé feedback they usually never receive.</p>
                        </div>
                    </div>
                    ...
                    <div className="lift-founder-links">
                        <a className="lift-credibility-link" href="https://www.linkedin.com/in/mattrshaw" target="_blank" rel="noopener noreferrer">
                            <LinkedinLogo aria-hidden="true" weight="fill" /> View Matt&apos;s LinkedIn
                        </a>
                        <Link className="lift-credibility-link" href="/methodology">See how the report works <ArrowRight aria-hidden="true" /></Link>
                    </div>
                    <p className="lift-founder-ai-note">Each report is generated by AI using a product shaped by Matt&apos;s recruiting experience. Matt does not personally review every submission.</p>
                ...
                <div className="lift-shell">
                    <div className="lift-hero-grid">
                        <div className="lift-hero-copy">
                            ...
                            <p className="lift-hero-deck">Get a recruiter&apos;s first impression, see the exact résumé lines that raise questions, and learn which changes matter most before you apply.</p>
                            <div className="lift-actions">
                                ...
                                <Link href="/workspace?sample=1" className="lift-button-secondary">See an example report</Link>
                            </div>
                            <div className="lift-hero-trust">
                                ...
                                <p className="lift-ai-disclosure">AI-powered feedback, shaped by <a href="https://www.linkedin.com/in/mattrshaw" target="_blank" rel="noopener noreferrer">Matt Shaw&apos;s</a> 14 years of real recruiting experience.</p>
                            </div>
                        </div>
                        <FirstReadHero />
                    </div>
