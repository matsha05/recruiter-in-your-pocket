...
export function SampleReport() {
    ...
    return (
        <div className="w-full max-w-4xl mx-auto px-4 md:px-0">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 px-4 md:px-6 py-3 md:py-4 mb-4 md:mb-6 rounded border border-border/50 bg-secondary/10">
